...
const resultsQuickSummary = [
  "地域の雇用と取引先を守り抜くため、先を読みながら迷わず決断できる状況をつくることを最優先に据えています。",
  "中小企業診断士と生成AIが5年先までの絵姿と計画書を共創し、経営管理アプリやダッシュボードを個別設計。",
  "国の補助金（https://www.chusho.meti.go.jp/keiei/saisei/05.html）の活用も視野に入れながら、金融機関・社員・経営陣が一体で動ける意思決定サイクルを整備。",
];
...
const resultsMomentumLevers = [
  "業界・競合・顧客・原価の調査を同時に進め、判断の土台となるデータを整然と蓄積。",
  "生成AIが粗利と資金の変動要因を可視化し、診断士が採るべき選択肢と実行条件を言語化。",
  "経営管理アプリを活用した週次レビューで、会議直後から現場が動き出す流れを固定化。",
];
...
const proofStories = [
  {
    ...
    narrative:
      "原材料高騰で粗利率が下がり続けたが、AIが調達条件と需要変化を読み解き、診断士が価格と人員の再配置を設計。経営陣が胸を張って投資判断を示し、6ヶ月で粗利率+3.2pt、キャッシュ余力+45日を確保。",
  ...
  },
  {
    ...
    narrative:
      "在庫滞留で債務超過に陥ったが、AIが滞留在庫と需要シフトを抽出。診断士が交渉資料とモニタリング設計を整え、金融機関との対話を主導できるようになり、追加融資と返済スケジュールの再設計に成功。",
  ...
  },
  {
    ...
    narrative:
      "離職率が高止まりし施策が属人化していたが、AIでスキルと稼働を可視化し、診断士が育成プランと評価の枠組みを再設計。働き方の手応えが共有され、平均客単価+18%、離職率▲35%（例）。",
      ...
      <div className="container mx-auto max-w-6xl px-4">
        <ScrollReveal variant="fade-up" className="space-y-6 text-center">
          ...
          <h2 className="text-3xl font-bold leading-tight md:text-4xl">
            未来を先読みして決断する資金繰り再構築と利益回復の確かな軌跡
          </h2>
          <p className="mx-auto max-w-4xl text-[1.05rem] leading-relaxed text-slate-200/90 md:text-lg">
            地域のリーダーが胸を張って次の一手を語れるよう、生成AIと診断士が資金繰り・粗利・人材のつながりを一枚に整理。銀行・社員・経営陣が同じ情報で即断し、先手のストーリーを数字で裏づけます。
          </p>
