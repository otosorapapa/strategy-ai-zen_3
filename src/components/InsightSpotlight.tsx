...
const insightHighlights = [
  {
    label: "意思決定の土台",
    value: "48時間で提示",
    caption: "資金・現場・市場の歪みを一枚に重ね、判断の焦点を共有",
  },
  {
    label: "設計図づくり",
    value: "AIと診断士",
    caption: "数字と現場ヒアリングを統合し、納得できる未来像を構築",
  },
  {
    label: "合意までの速さ",
    value: "会議1回で決定",
    caption: "前提共有の型紙を用意し、論点議論にすぐ移れる状態へ",
  },
];
...
const blueprintAssurances = [
  {
    title: "因果整合",
    metric: "因果の記録",
    description: "粗利・資金・現場指標のつながりを色と位置で示し、判断の根拠を可視化。",
  },
  {
    title: "論点同期",
    metric: "議題の整流",
  ...
  },
  {
    title: "実装耐性",
    metric: "実行の適合",
    description: "部門別の制約と投資余地を同じ層で示し、その場で合意形成に接続。",
  },
];
          ...
          <div className="mx-auto w-full max-w-2xl space-y-12 lg:max-w-none">
            <ScrollReveal variant="fade-up" className="space-y-4">
              ...
              <div className="space-y-4 text-[1.05rem] leading-relaxed text-[#1e3359]/80 md:text-lg">
                <p>
                  原価や採用の変化を把握していても、数字と現場の肌感覚が別々に管理されていると、経営の灯は揺らぎます。月次資料を整えるだけで時間が尽き、未来の仮説づくりに手が回らない──それが停滞の正体です。
                </p>
                <p>
                  私たちが目指すのは、経営者が次の一手を確信を持って語れる舞台です。先を読む指標と語りの筋道が揃えば、社内外からの期待に堂々と応えられるようになります。
                </p>
                <p>
                  創和経営コンサルティングは、生成AIが示す兆しと診断士の現場ヒアリングを重ね、業界・競合・顧客の調査から計画策定、ダッシュボード運用までを一貫して伴走します。意思決定の質・速さ・先見性を底上げし、次の成長を引き寄せる行動へ接続します。
                </p>
              </div>
            </ScrollReveal>
