...
const heroValueBullets = [
  "経営者が描く未来像を言語化し、数字と現場の声を一枚に束ねた判断軸に磨き上げる",
  "生成AIが業界・顧客・コストを横断的に分析し、診断士が実行の段取りへ落とし込む",
  "金融機関や社員に胸を張って示せる経営改善計画とダッシュボードを短期間で整える",
];
...
const heroSummaryCards = [
  {
    icon: Timer,
    eyebrow: "初動",
    title: "Day0→Day2で兆しと優先課題を共有",
    description: "生成AIが外部環境と社内数値を照合し、経営判断の焦点を整理",
  },
  {
    icon: Landmark,
    eyebrow: "設計",
    title: "Day7で再生シナリオを描写",
    description: "診断士が現場ヒアリングを重ね、実効性ある打ち手に設計",
  },
  {
...
const heroIntroCopy = {
  short:
    "変化の兆しは捉えていても、確信を持って一歩を示すには裏付けが欠かせません。生成AIが広い視野で兆候を読み、中小企業診断士が現場の温度感を整えます。貴社専用の経営改善計画と管理アプリを共創し、金融機関や社員に誇りを持って語れる次の一手へ導きます。",
};
          ...
          <div className="space-y-10">
            <div className="space-y-6">
              ...
              <p className="max-w-2xl text-sm leading-relaxed text-slate-100/80 md:text-base">
                変化の荒波でも経営者が迷わず指揮を執れる舞台を整えることが私たちの使命です。生成AIと診断士の協働で停滞の要因を可視化し、判断の質と速さ、先を読む力を引き上げます。
              </p>
            </div>
