...
const Footer = () => {
  return (
    <footer className="fade-in-section border-t border-border bg-background py-12 text-foreground">
        ...
        <div className="mx-auto grid max-w-6xl gap-10 md:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              福岡発の再生デザインスタジオ。生成AIと中小企業診断士の伴走で、年商5,000万円〜10億円未満規模の企業が粗利・キャッシュ・現場の動きを再構築できるよう支援します。経営改善計画策定支援補助金を活用した計画策定・申請まで一気通貫でサポートします。
            </p>
            <div className="pt-3">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm text-muted-foreground">
              ...
              <div className="flex items-center gap-3">
                ...
                <a
                  href="mailto:10vance.re.silie.nce@gmail.com"
                  className="text-foreground transition-smooth hover:text-primary"
                >
                  10vance.re.silie.nce@gmail.com
                </a>
              </div>
              <div className="flex items-start gap-3">
          ...
          <div className="space-y-4">
            ...
            <div className="pt-5">
              ...
              <div className="flex gap-4">
                <a
                  href="https://www.facebook.com/profile.php?id=61575087356301"
                  target="_blank"
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-2 text-sm text-muted-foreground">
              <p>
                ...
                <a
                  href="#cta-section"
                  className="font-semibold text-primary underline-offset-4 transition-smooth hover:text-primary/80 hover:underline"
                >
                  {PRIMARY_CTA.label}
                </a>{" "}
                をリクエストしてください。
