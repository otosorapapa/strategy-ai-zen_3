...
const heroBullets = [
  "資金・需要・人材の歪みを一枚の“再生の設計図”に集約し、判断の迷いを断ち切る",
  "生成AIが業界トレンドと自社データを解析。専門家（中小企業診断士）が現場のリアリティを織り込む",
  "金融機関・幹部・現場へ伝える資料まで連動し、再起への一歩を切り出す勇気を支える",
];
          ...
          <div className="space-y-10">
            <div className="space-y-6">
              ...
              <p className="max-w-3xl text-[1.05rem] leading-relaxed text-slate-100/90 md:text-lg">
                ...
                変化の速さに合わせて更新されるべき“未来の設計図”が欠けているからです。私たちは生成AIの解析力と中小企業診断士の経験知を重ね、粗利・キャッシュ・現場の気配を同じ時間軸に整列させます。経営者が再び判断に確信を持ち、未来を語れる状態をともに築きます。
              </p>
            </div>
