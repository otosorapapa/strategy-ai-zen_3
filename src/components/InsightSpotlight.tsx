          ...
          <div className="mx-auto w-full max-w-2xl space-y-12 lg:max-w-none">
            <ScrollReveal variant="fade-up" className="space-y-4">
              ...
              <div className="space-y-4 text-[1.05rem] leading-relaxed text-[#1e3359]/80 md:text-lg">
                <p>
                  原価の揺らぎも採用環境の変化も把握できているのに、数字と現場の手応えが別々に積み上がる。月次資料を整えるだけで議論の時間が尽き、未来の打ち手に踏み切れない──その状況こそ意思決定のスピードと先見性を奪います。
                </p>
                <p>
                  創和経営コンサルティングは、生成AIが読み解く兆しと中小企業診断士の現場ヒアリングを重ね、判断の座標軸を整えます。経営会議で語るべき筋道と実行の段取りを一本化し、経営者が未来を語る場で確かな手応えを示せるよう伴走します。
                </p>
              </div>
            </ScrollReveal>
