...
const reassuranceItems = [
  ...
  { icon: ShieldCheck, label: "初月トライアルで検証" },
  { icon: Lock, label: "守秘義務契約対応" },
] as const;

const SectionCtaBanner = ({ eyebrow = "無料相談・仮診断・資料DLを選べます", title, description, className }: SectionCtaBannerProps) => {
  const handleClick = () => {
  ...
  return (
    <section className={cn("fade-in-section py-10", className)} aria-label="セクション区切りCTA">
