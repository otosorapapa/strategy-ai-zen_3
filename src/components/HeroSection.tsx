...
const heroValueBullets = [
  "先を示すための兆候・現場の声・数字を一枚の設計図に整理",
  "生成AIが業界・顧客・コストを解析し、診断士が最短ルートの行動計画に翻訳",
  "堂々と語れる経営改善計画とダッシュボードで次の挑戦を後押し",
];
...
const heroSummaryCards = [
  {
    icon: Timer,
    eyebrow: "初動",
    title: "Day0→Day2で兆しを整理",
    description: "生成AIが外部環境と社内データを突き合わせ、判断材料を色分け",
  },
  {
    icon: Landmark,
    eyebrow: "設計",
    title: "Day7で合意できる計画案",
    description: "診断士がヒアリングを重ね、実現性と優先順位を揃えた打ち手に整理",
  },
  {
    icon: BriefcaseBusiness,
    eyebrow: "展開",
    title: "Day30で社内外の説明を刷新",
    description: "取引先や関係機関に示せる根拠資料と行動計画を整備",
  },
];
...
const heroIntroCopy = {
  short:
    "景況の揺らぎや主力顧客の動きを把握していても、確信を持って示す材料が分断されていると足踏みが続きます。創和経営コンサルティングは、生成AIが集めた兆しを中小企業診断士が現場の言葉に整え、次の一手を描ける判断ボードへ翻訳します。迷いを削り、仲間と関係者に胸を張って語れる計画づくりを伴走します。",
};
          ...
          <div className="space-y-10">
            <div className="space-y-6">
              ...
              <h1 className="text-balance text-3xl font-bold leading-[1.45] md:text-4xl md:leading-[1.5] xl:text-[3.1rem]">
                生成AIと診断士が、先を読む経営改善計画で貴社の判断を更新する。
              </h1>
              <p className="max-w-2xl text-sm leading-relaxed text-slate-100/80 md:text-base">
                情報が点在したままでは、意思決定の質もスピードも損なわれてしまいます。私たちは停滞の根を特定し、先を見越した計画と実行環境を整えることで、経営者が自信を持って方向性を示せる状態をつくります。
              </p>
            </div>
