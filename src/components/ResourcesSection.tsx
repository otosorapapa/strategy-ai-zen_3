...
const ResourcesSection = () => {
  ...
  return (
    <section id="resources" className="fade-in-section py-12 md:py-16 bg-white">
      <div className="container mx-auto px-3 sm:px-4">
        <div className="mx-auto max-w-5xl">
                  ...
                  <Card className="flex h-full flex-col justify-between border border-border bg-card p-5 shadow-card">
                    ...
                    <div className="mt-5 flex flex-col gap-3">
                      ...
                      <p className="text-center text-xs text-muted-foreground">
                        30分相談や仮診断をご希望の方はページ下部の <span className="font-semibold text-primary">{PRIMARY_CTA.label}</span> からどうぞ。
                      </p>
                    </div>
                  </Card>
                </ScrollReveal>
          ...
          <ScrollReveal
            ...
            variant="fade-up"
          >
            <h3 className="text-xl font-semibold text-foreground">30分相談でできること</h3>
            <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
              専門コンサルタントが御社の業務フローをヒアリングし、「どの業務で生成AIが役立つか」「データ準備に必要なステップ」「導入初月に達成すべきKPI」を具体的に提案します。公式デモサイト「furumachi-smec.lognowa.com」で公開しているデモをベースに、貴社向けカスタマイズ案もその場でお渡しします。
            </p>
          </ScrollReveal>
        </div>
      </div>
