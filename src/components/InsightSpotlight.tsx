...
const insightHighlights = [
  {
    label: "揺らぎの原因",
    value: "48時間で整理",
    caption: "資金・現場・市場の歪みを一本化し、迷いの正体を示す",
  },
  {
    label: "描き出す内容",
    value: "AIと診断士で精査",
    caption: "定量と定性を重ね、語れる再生シナリオへ磨き込む",
  },
  {
    label: "実行への移行",
    value: "会議1回で前進",
    caption: "前提を共有し、論点を即座に行動へ落とし込む",
  },
];
          ...
          <div className="mx-auto w-full max-w-2xl space-y-12 lg:max-w-none">
            <ScrollReveal variant="fade-up" className="space-y-4">
              ...
              <h2 className="text-3xl font-bold leading-tight md:text-4xl">
                変化に振り回される不安を言語化し、堂々と未来を語れる判断軸を整える
              </h2>
              <div className="space-y-4 text-[1.05rem] leading-relaxed text-[#1e3359]/80 md:text-lg">
                <p>
                  原価や採用環境の揺らぎを把握していても、数字と現場の手応えが別々に積み上がると次の指示が鈍ります。迷いの根本を明らかにしない限り、意思決定の速さと先を読む力は磨かれません。
                </p>
                <p>
                  私たちは生成AIが読み解く兆しと中小企業診断士の対話力を重ね、経営改善（事業再生）計画を貴社専用に描き直します。財務・顧客・現場の論点を一本化し、経営者が胸を張って示せる筋道を用意します。
                </p>
                <p>
                  ダッシュボードと伴走支援で実行まで支え、週次の対話で判断材料を更新。外部環境の変化を映し出しながら、次の一手を自信を持って選び取れる状態を守ります。
                </p>
              </div>
            </ScrollReveal>
