...
const heroValueBullets = [
  "市場の揺らぎと社内の声を一枚に束ね、守るべき優先順位を明確にする",
  "生成AIが業界・顧客・コストを解析し、中小企業診断士が実行可能な道筋へ磨き上げる",
  "貴社仕様の経営改善計画とダッシュボードで、会議のたびに自信を持って方針を提示できる",
];
...
const heroIntroCopy = {
  short:
    "生成AIが業界・顧客・資金の兆候を一気に集め、中小企業診断士が現場の感覚と結び合わせます。貴社専用の管理アプリと経営改善計画を組み上げ、取引先や社内に堂々と示せる再生シナリオを描きます。",
};
          ...
          <div className="space-y-10">
            <div className="space-y-6">
              ...
              <h1 className="text-balance text-3xl font-bold leading-[1.45] md:text-4xl md:leading-[1.5] xl:text-[3.1rem]">
                先を読む意思決定を磨く経営改善支援を、生成AIと診断士が貴社仕様で届ける。
              </h1>
              <p className="max-w-2xl text-sm leading-relaxed text-slate-100/80 md:text-base">
                市場の読み違いが許されない局面で、経営者が迷わず舵を切れる状態を守り抜くことが私たちの役割です。福岡の創和経営コンサルティングが、未来志向の計画で貴社の意思決定を支えます。
              </p>
            </div>
